...
private:
   ...
   Real m_fMinCacheX, m_fMaxCacheX;
   Real m_fMinCacheY, m_fMaxCacheY;
   bool m_bResetAll;

   Real m_fCacheValue, m_fTargetValue;

   CRandom::CRNG* m_pcRNG;
   CRange<Real> m_cLightGrayRange; 
   CRange<Real> m_cDarkGrayRange;
